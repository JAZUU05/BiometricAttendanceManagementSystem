...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2022 at 08:43 AM
...
INSERT INTO `login_admin` (`id`, `employee_id`, `name`, `username`, `password`, `dt_updated`, `dt_created`) VALUES
(5, 0, 'admin', 'admin', 'admin', '2022-10-16 14:05:41', '2022-10-12 21:53:16');
...
INSERT INTO `position` (`position_id`, `job_title`, `description`, `dt_updated`, `dt_created`) VALUES
(4, 'Secretary', 'Sec', '2022-10-25 13:09:23', '2022-10-25 21:09:23');
...
--
ALTER TABLE `fingerprint`
  MODIFY `fingerprint_id` int(12) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `position`
  MODIFY `position_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
